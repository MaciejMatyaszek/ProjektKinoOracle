            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="text-center">
                        ...
                        <font class="text-gray-900 mb-4" size="8">Dodaj dane osobowe</font>
                    </div>
                    <br>
                    <form:form action="saveDaneOsobowe" modelAttribute="dane_osbowe"  method="post">
                        <form:hidden path="id_dane_osobowe" />
                        <form class="user">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p>Data urodzenia:</p>
                                    <form:input path="data_urodzenia" name="data_urodzenia" />
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p>Numer: </p>
                                    <form:input path="numer" name="numer" />
                                </div>
