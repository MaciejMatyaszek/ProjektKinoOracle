            ...
            <div class="Daneosobowe">
                ...
                <form:form action="saveStrona" modelAttribute="daneosoowe" method="post" name="dane_osobowe">
                    ...
                    <form:hidden path="id_dane_osobowe"></form:hidden>
                        <p style="text-align: center; font-size: 33px; color: white; margin-left: 50px;">${seans.film.tytul} ${seans.data} ${seans.godzina}</p>
                    <table style="color:white; text-align: center;">
                        ...
                        <tr>
                            ...
                            <td><form:input path="imie" name="data"/>
                             </td>
                        </tr>
                        <tr>
                            <td><label>Nazwisko:  </label></td>
                            <td><form:input path="nazwisko" name="gatunek"  />
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><form:input  type="email" path="email" name="gatunek"/> </td>
                        </tr>
                        <tr>
                        ...
                        <td><label> </label></td>
                        <td><input type="submit" value="Zapisz" class="save" style="width: 200px; margin: 10px;"/> </td>
                        </tr>
