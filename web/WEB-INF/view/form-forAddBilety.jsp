        ...
        <div class="card-body p-0" >
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <br>
                    <form:form action="saveBilety" modelAttribute="bilety"  method="post">
                        <form:hidden path="bilet_id" />
                        <form class="user">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="id_rezerwacji" >
                                            <c:forEach var="v" items="${rezerwacje}">

                                                <option value="${v.id_rezerwacje}">${v.id_rezerwacje}</option>
                                            </c:forEach>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <a href="${pageContext.request.contextPath}/showBilety" class="btn btn-secondary btn-user btn-block">
                                        Anuluj
                                    </a>
                                </div>
                                <div class="col-sm-2">
