            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="text-center">
                        ...
                        <font class="text-gray-900 mb-4" size="8">Dodaj rezerwacje</font>
                    </div>
                    <br>
                    <form:form action="saveSeans" modelAttribute="seans"  method="post">
                        ...
                        <form class="user">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Seans:</font></p>


                                    <form:input path="data" name="data" />
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Godzina:</font></p>


                                    <form:input path="godzina" name="godzina"/>
                                </div>
