    ...
    <header>
        ...
        <section>
            <div class="row">
                <div class="asd col-12 align-self-center">
                    ...
                    <a    href=""${pageContext.request.contextPath}/kontakt" style="text-decoration:none; color:white"><img src="${pageContext.request.contextPath}/reso
        ...
        <div class="Rezerwacje">
                    ...
                    <div class="Daneosobowe">
                            ...
                            tr>
                            <td>Normalny: </td>	<td>24,00 zł</td>
                            </tr>
                            <tr>
                            <td>Ulgowy:  </td>	<td>20,00 zł</td>
                            </tr>
                            <tr>
                            <td>Junior/Senior:  </td>	<td>20,00 zł</td>
                            </tr>
                            <tr>
                            <td>Rodzinny:  </td>	<td>20,00 zł</td>
                            </tr>
                            </table>
