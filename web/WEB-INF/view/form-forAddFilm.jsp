            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <form:form action="saveFilm" modelAttribute="film"  method="post">
                        <form:hidden path="id_filmu"  name="id_filmu"/>
                        <form class="user">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <form:input path="tytul" name="tytul" />
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <form:input path="czas_trwania" name="czas_trwania"/>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <form:select path="gatunek" name="gatunek">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Reżyser:</font></p>
                                    <form:input path="rezyser" name="rezyser"/>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Opis:</font></p>
                                    <form:input path="opis" name="opis"/>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <form:input path="wymaganyWiek" name="wymaganyWiek"/>
                                </div>
