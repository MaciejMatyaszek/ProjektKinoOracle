            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="text-center">
                        ...
                        <font class="text-gray-900 mb-4" size="8">Dodaj Sale</font>
                    </div>
                    <br>
                    <form:form action="saveSala" modelAttribute="sala"  method="post">
                        <form:hidden path="id_sali" />
                        <form class="user">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Nazwa:</font></p>


                                    <form:input path="nazwa" name="nazwa" />
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p><font size="4">Miejsca:</font></p>


                                    <form:input path="miejsca" name="miejsca"/>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <a href="${pageContext.request.contextPath}/showSala" class="btn btn-secondary btn-user btn-block">
                                        Anuluj
                                    </a>
                                </div>
                                <div class="col-sm-2">
